def UnitTestFunction(module, exec_code, TestingExpressionsAndExpectedResults,
    ...
    """
    import_module = "import VAR"
    import_module = import_module.replace('VAR', module)
    print(import_module)
    exec(import_module)
    exec(exec_code)
    print(introdaction, '\n')
    ...
    for testingExpression, expectedResult in TestingExpressionsAndExpectedResults:
        ...
        expectedRes = eval(expectedResult)
